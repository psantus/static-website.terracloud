...
const AWSMigration = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('services.awsMigration.title')} - TerraCloud</title>
        <meta name="description" content={t('services.awsMigration.description')} />
      </Helmet>
        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-cyan-100 mb-8">
              {t('services.awsMigration.description')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to={createUrl('/prendre-rendez-vous')} className="btn-primary bg-white text-cyan-600 hover:bg-gray-100">
                {t('services.hero.cta1')}
              </Link>
              <Link to={createUrl('/nous-contacter')} className="btn-secondary border-white text-white hover:bg-white hover:text-cyan-600">
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {(t('services.awsMigration.features', { returnObjects: true }) as string[]).map((feature, index) => (
