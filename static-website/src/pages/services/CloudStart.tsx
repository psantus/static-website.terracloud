...
const CloudStart = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('services.cloudStart.title')} - TerraCloud</title>
        <meta name="description" content={t('services.cloudStart.description')} />
      </Helmet>

      {/* Hero Section */}
      <section className="bg-gradient-to-br from-green-600 to-teal-600 text-white section-padding">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold">
                {t('services.cloudStart.title')}
              </h1>
            </div>
            <p className="text-xl text-green-100 mb-8">
              {t('services.cloudStart.description')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to={createUrl('/prendre-rendez-vous')} className="btn-primary bg-white text-green-600 hover:bg-gray-100">
                {t('services.hero.cta1')}
              </Link>
              <Link to={createUrl('/nous-contacter')} className="btn-secondary border-white text-white hover:bg-white hover:text-green-600">
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {(t('services.cloudStart.features', { returnObjects: true }) as string[]).map((feature, index) => (
